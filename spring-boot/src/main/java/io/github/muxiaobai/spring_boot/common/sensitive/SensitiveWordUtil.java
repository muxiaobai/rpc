package io.github.muxiaobai.spring_boot.common.sensitive;
...
public class  SensitiveWordUtil{
    ...
    public static void main(String[] args) {
        ...
        String string = "太多的伤感情怀也许只局限于饲养基地 荧幕中的情节。"
                + "然后我们的扮演的角色就是跟随着主人公的喜红客联盟 怒哀乐而过于牵强的把自己的情感也附加于银幕情节中，哈哈哈哈，我是中国人，然后感动就流泪，"
